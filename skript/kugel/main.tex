...
\begin{center}
        \includegraphics[width=0.4\textwidth]{kugel/_HalbeKugel.jpg}
...
\begin{center}
        \includegraphics[width=0.3\textwidth]{kugel/_SphärischerExzess.jpg}
...
\begin{center}
        \includegraphics[width=0.3\textwidth]{kugel/_Sinussatz2.jpg}
    \captionof{figure}{Bild Sinussatz}
\end{center}
