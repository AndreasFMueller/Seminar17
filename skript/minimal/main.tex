...
\section{Einleitung}
\rhead{Einleitung}
Was sind Minimalflächen? Wie werden sie definiert? Warum passen sie in den Kontext dieses Buches?
\\
...
\section{Katenoid}
Wie der Name erahnenläst beschreiben Minimalflächen Formen mit minimalem Flächeninhalt. 
...
Anders formuliert ist die Gausskrümmung ein Mass für die innere Krümmung einer Fläche, der Fachbegriff für diese Art Krümmung ist intrinsische Krüm-mung. 
...
Folgend wird zuerst das Konzept der Krümmung kurz zusammengefast und anschliessend der Unterschied der mittleren und Gausskrümmung im Bezug auf Minimalflächen illustriert, befor dies alles mit dem Beispiel der Sattelfläche visualisiert wird.
...
Anders sieht es zum Beispiel bei einer Sattelfläche (Pringels-Chips artigen Fläche) dort ist die Gausskrümmung ungleich null, hingegen kann die Mittlere Krümmung im Spezialfall, dass $R1=-R2$ also die Krümmungsradien ein umgekehrtes Vorzeichen aufweisen aber vom Betrag her identisch sind, gleich null sein. In diesem Fall ist diese Sattelfläche ein Beispiel für eine Minimalfläche.
...
\section{Young–Laplace - Oberflächenspannung}




TODO: Enfürende worte zu Young–Laplace - Oberflächenspannung mit weiterer definition.............................
...
TODO: ???????????????????????Definitionen von oben bei Beispiel Katenoid, Sattelfläche,Young Laplace noch einbauen dann eigener abschnitt löschen???????????????????????
