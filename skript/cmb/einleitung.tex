...
\begin{figure}
	...
	\caption{Entstehung des Universums im Zeitverlauf. Beim "Last Scattering" Prozess wurde das Universum
		sichtbar}
...
Wasserstoffatomen verbinden konnten (siehe Abbildung \ref{fig:recombination}).
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{cmb/images/recombination.jpg}
	\caption{Protonen, Neutronen und Photonen vor (oben) und nach (unten) der Rekombination }
