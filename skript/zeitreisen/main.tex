...
\begin{align*}
    ...
    =
    \frac{1}{c}\int_{}^{}\sqrt{-(-c^2 +(uc)^{2}}ds\\
    &=
    \frac{s\sqrt{c^2+(uc)^{2}}}{c} 
    =
    s\sqrt{1-\frac{u^2c^2}{c^2}}
\end{align*}
...
\subsection{Gravitation}
	...
	Ein beschleunigtes Koordinatensystem kann zwar durch eine Koordinatentransformation erreicht werden, doch diese ist keine Lorentztransformation und lässt sich nicht durch die die Minkowski-metrik darstellen.
