...
bevorzugte Richtung geben darf, in die sich die Materie im Universum
bewegt.
...
\lstinputlisting[style=Maxima]{chapters/friedmann.maxima}
Wir bekommen so
...
Für Energie, die in Form von Strahlung vorliegt, trifft dies jedoch nicht
zu.
...
der Strahlung, wird im Laufe der Geschichte des Universums die
...
\index{Dichteparameter}%

%\subsection{Der Einfluss des Krümmungsparameters $\kappa$}
%Es fällt auf, dass in der Friedmann-Gleichung die Ableitung
...
%\]
%In einem sich ausdehnenden Universum nimmt die Dichte $\varrho(t)$
%nach \eqref{skript:friedmann:zustandmaterie} mit
...
-\frac{c^2\kappa}{a(t)^2R_c^2}.
\]
Die linke Seite dieser Gleichung ist immer positiv.
...
%\rhead{Komponenten in einem flachen Universum}
...
Setzt man die besten bekannten Werte ein, erhält man 9.6Gyr,
...
\]
bestimmen.
Aus $a(t)=0$ schliessen wir für $t-t_0$
\[
H_0(t-t_0)
=
-1
...
Er fügte ihnen daher einen Term hinzu, der dies ermöglichte.
...
Ausserdem interessiert uns der genaue Wert von $\varrho_0$ nicht wirklich,
...
In Abbildung~\ref{skript:friedman:graph:darkenergy} sind numerisch
gewonnene Lösungen
...
Energiedichte des aktuellen Universums ausmacht, darüber gibt es verschiedene
