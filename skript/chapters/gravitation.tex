...
Die Newtonsche Theorie soll als Grenzfall herauskommen, so dass
$a$ bereits als $a=1$ festgelegt ist.
Damit folgt $b=-\frac12$ und damit erhalten wir die folgende Definition
