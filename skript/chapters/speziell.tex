...
sind, weil sie
zum Beispiel erst bei sehr grossen Geschwindigkeiten
sichbar werden.
...
Die Newtonsche Theorie ist daher schon im Ansatz nicht mit der
...
Punkt des Raumes den Vierer\-impuls der dort vorhandenen Materie zu
berechnen gestattet.
...
Ein ideales Gas ist isotrop, in alle Richtungen wirken die gleichen 
Druckkräfte.
...
Materie kann nicht einfach entstehen oder zerstört werden, für diese 
Tatsache muss es einen mathematischen Ausdruck geben.
...
Aus der Dichte können wir die Masseänderung aber ebenfalls berechnen,
es ist
\[
\Delta m
=
...
Für langsam bewegte Objekte sind die Raumkomponenten $\dot x^i(t)$
