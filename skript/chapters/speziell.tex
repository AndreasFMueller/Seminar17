...
=
\frac{1}{\gamma}\cdot\frac{v}{c}
&
&\text{mit}&
\gamma = \sqrt{1-\biggl(\frac{v}{c}\biggr)^2}
\qquad\text{und}
\\
\cosh\beta
&=
...
\begin{equation}
t'=t\cdot\frac{1}{\gamma} = \frac{t}{\displaystyle\sqrt{1-\biggl(\frac{v}{c}\biggr)^2}},
\label{skript:speziell:zeitdilatation}
\end{equation}
der Lauf der Zeit ist in den beiden Koordinatensystemen verschieden.
Im $t'$-$x'$-Koordinatensystem läuft die Zeit um den Faktor $1/\gamma$
gedehnt.
...
=
\begin{pmatrix}
\displaystyle \frac{1}{\gamma}&\displaystyle\frac{v}{c\gamma}& 0 & 0 \\
\displaystyle\frac{v}{c\gamma}&\displaystyle \frac{1}{\gamma}& 0 & 0 \\
      0                       &                              & 1 & 0 \\
      0                       &                              & 0 & 1 
\end{pmatrix}
\begin{pmatrix}
