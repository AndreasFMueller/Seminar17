...
\fill[gray!10]	(A) .. controls (7,4) and (9,4) ..
...
\draw[line width=0.1] (F)--(2,0);
\draw[line width=0.1] (C)--(18,0);

\draw[line width=0.1] (D)--(0,15);
\draw[line width=0.1] (A)--(0,4);
...
\draw[line width=0.1,fill=white] (A) circle[radius=0.15] {};
\draw[line width=0.1,fill=white] (D) circle[radius=0.15] {};
%\draw[line width=0.1,fill=white] (C) circle[radius=0.15] {};
%\draw[line width=0.1,fill=white] (F) circle[radius=0.15] {};
