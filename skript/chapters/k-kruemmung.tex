...
Mit diesem Trick können wir das Problem auf eine zweidmensionale
Fläche reduzieren.
...
die als Tangentialrichtung die Reichtung der beiden gegebenen
...
Dieser Vektor muss linear von $u^\mu$, $v^\mu$ und $x^\mu$ abehängen,
wir erwarten also, dass in jedem Punkt Zahlen
$R^\alpha\mathstrut_{\mu\nu\sigma}$ geben muss, mit denen mann
$y^\mu$ berechnen kann:
\[
